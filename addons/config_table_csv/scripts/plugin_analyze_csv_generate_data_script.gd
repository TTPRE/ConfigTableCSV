...
static func generate_data_script(data: Array[PackedStringArray], csv_dir_path: String, csv_file_name_without_suffix: String) -> void:
	...
	var data_script_path : String = csv_dir_path + csv_file_name_without_suffix + PluginConfigHelper.DATA_SCRIPT_NAME_SUFFIX
	...
	data_script_file.store_line(PluginConfigHelper.NEW_FILE_ANNOTATION)
